...
public class EncodedText {
    ...
    public static final byte TEXT_ENCODING_CP_1251 = 4;

    public static final String CHARSET_ISO_8859_1 = "ISO-8859-1";
    public static final String CHARSET_UTF_16 = "UTF-16LE";
    public static final String CHARSET_UTF_16BE = "UTF-16BE";
    public static final String CHARSET_UTF_8 = "UTF-8";
    public static final String CHARSET_CP_1251 = "windows-1251";
    ...
    private static final byte[] textEncodingFallback = {0, 2, 1, 3, 4};
    ...
    private static byte getTextEncodingForBytes(byte[] value) {
        ...
        } else if (CHARSET_UTF_16BE.equals(charsetName)) {
            return TEXT_ENCODING_UTF_16BE;
        } else if (CHARSET_UTF_8.equals(charsetName)) {
